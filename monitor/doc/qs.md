% @CMD@(snig) Version 1.0 | Examine Job Sequence Status
...
+--------+-----------------------------------------------+--------------+----------------+------------+---------+
| seq0   | Direção Regional do Ordenamento do Território | 3            | 10             | 114        | queued  |
| seq1   | Direção-Geral de Energia e Geologia           | 1            | 11             | 60         | queued  |
| seq2   | Direção-Geral do Património Cultural          | 1            | 9              | 10         | pending |
+--------+-----------------------------------------------+--------------+----------------+------------+---------+
...
The columns have the following meanings
 ...
 6. Status: Can be "queued" or "pending". A queued sequence is still sitting in the job sequences\
    round-robin. When a job sequence has finished to schedule its jobs but some of them are still\
