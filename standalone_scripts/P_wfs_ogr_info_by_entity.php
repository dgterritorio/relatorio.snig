...
// Query the view
$query = 'SELECT gid, entity, status_code, definition, count, ping_average FROM stats_and_metrics._14_group_by_wfs_ogr_info_validity_and_entity';
...
<b style="font-size: 24px;">WFS OGR_INFO RESPONSE by Entity</b>
