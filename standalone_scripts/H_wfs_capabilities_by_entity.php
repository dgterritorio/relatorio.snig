...
// Query the view
$query = 'SELECT gid, entity, status_code, definition, count, ping_average FROM stats_and_metrics._08_group_by_wfs_capabilities_validity_and_entity';
...
<b style="font-size: 24px;"><a href="/pages/_08_group_by_wfs_capabilities_validity_and_entity.csv">WFS CAPABILITIES DOCUMENT VALIDITY by Entity</a></b>
<br/><br/>
<table>
    <tr>
        <th>Entity</th>
