...
// Query the view
$query = 'SELECT gid, entity, status_code, definition, count, ping_average FROM stats_and_metrics._07_group_by_wms_capabilities_validity_and_entity';
...
?>
<div id="G"></div>
<b style="font-size: 24px;"><a href="/pages/_07_group_by_wms_capabilities_validity_and_entity.csv">WMS CAPABILITIES DOCUMENT VALIDITY by Entity</a></b>
<br/><br/>
<table>
    <tr>
        <th>Entity</th>
