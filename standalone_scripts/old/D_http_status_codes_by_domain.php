...
// Query the view
$query = 'SELECT gid, uri_domain, status_code, status_code_definition, count, ping_average FROM stats_and_metrics._04_group_by_http_status_code_and_domain';
...
?>
<div id="D"></div>
<b style="font-size: 24px;"><a href="/pages/_04_group_by_http_status_code_and_domain.csv">HTTP STATUS CODES by Domain</a></b>
<br/><br/>
<table>
    <tr>
        <th>Domain</th>
    ...
    <?php while ($row = pg_fetch_assoc($result)): ?>
        <tr>
            ...
            <td><?php echo htmlspecialchars($row['status_code_definition']); ?></td>
