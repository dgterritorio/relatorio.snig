...
// Query the view
$query = 'SELECT gid, entity, url_start, count FROM stats_and_metrics._01_group_urls_by_http_protocol_and_entity';
...
?>
<div id="A2"></div>
<b style="font-size: 24px;"><a href="/pages/_01_group_urls_by_http_protocol_and_entity.csv">HTTP vs HTTPS by Entity</a></b>
<br/><br/>
<table>
    <tr>
        <th>Entity</th>
