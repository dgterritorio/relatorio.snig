...
// Query the view
$query = 'SELECT gid, uri_domain, status_code, definition, count, ping_average FROM stats_and_metrics._16_group_by_wfs_ogr_info_validity_and_domain';
...
<b style="font-size: 24px;"><a href="/pages/_16_group_by_wfs_ogr_info_validity_and_domain.csv">WFS OGR_INFO RESPONSE by Domain</a></b>
<br/><br/>
<table>
    <tr>
        <th>Entity</th>
