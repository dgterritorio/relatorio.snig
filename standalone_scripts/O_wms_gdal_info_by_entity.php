...
// Query the view
$query = 'SELECT gid, entity, status_code, definition, count, ping_average FROM stats_and_metrics._13_group_by_wms_gdal_info_validity_and_entity';
...
?>
<div id="O"></div>
<b style="font-size: 24px;"><a href="/pages/_13_group_by_wms_gdal_info_validity_and_entity.csv">WMS GDAL_INFO RESPONSE by Entity</a></b>
<br/><br/>
<table>
    <tr>
        <th>Entity</th>
