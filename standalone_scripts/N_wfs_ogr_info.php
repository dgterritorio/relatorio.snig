...
// Query the view
$query = 'SELECT gid, status_code, definition, count, ping_average FROM stats_and_metrics._12_group_by_wfs_ogr_info_validity_global';
...
?>
<div id="N"></div>
<b style="font-size: 24px;"><a href="/pages/_12_group_by_wfs_ogr_info_validity_global.csv">WFS OGR_INFO RESPONSE</a></b>
<br/><br/>
<table>
    <tr>
        <th>Validity</th>
