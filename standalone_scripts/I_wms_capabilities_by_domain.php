...
// Query the view
$query = 'SELECT gid, uri_domain, status_code, definition, count, ping_average FROM stats_and_metrics._09_group_by_wms_capabilities_validity_and_domain';
...
<b style="font-size: 24px;">WMS CAPABILITIES DOCUMENT VALIDITY by Domain</b>
