...
// Query the view
$query = 'SELECT gid, uri_domain, status_code, definition, count, ping_average FROM stats_and_metrics._15_group_by_wms_gdal_info_validity_and_domain';
...
<b style="font-size: 24px;"><a href="/pages/_15_group_by_wms_gdal_info_validity_and_domain.csv">WMS GDAL_INFO RESPONSE by Domain</a>
<br/><br/>
<table>
    <tr>
        <th>Entity</th>
